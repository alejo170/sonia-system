...
import { updateGrade } from '@/app/lib/actions';
import { useFormState } from 'react-dom';

export default function EditGradeForm({ grade }: { grade: Grade }) {
  const initialState = { message: null, errors: {} };
  const updateGradeWithId = updateGrade.bind(null, grade.id);
  const [state, dispatch] = useFormState(updateGradeWithId, initialState);
  return (
