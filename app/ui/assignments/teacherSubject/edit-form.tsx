...
import { updateAssignmentsTeacherSubject } from '@/app/lib/actions';
import { useFormState } from 'react-dom';

export default function EditTeacherSubjectForm({
  teacherSubject,
  teachers,
  subjects,
  grades,
}: {
  teacherSubject: AssignmentsTeacherSubject;
  teachers: Teacher[];
  subjects: Subject[];
  grades: Grade[];
}) {
  const initialState = { message: null, errors: {} };
  const updateTeacherSubjectWithId = updateAssignmentsTeacherSubject.bind(
    null,
    teacherSubject.id,
  );
  const [state, dispatch] = useFormState(
    updateTeacherSubjectWithId,
    initialState,
  );
        ...
        <div className="mb-4">
          ...
          <div className="relative">
            <select
              ...
              defaultValue={teacherSubject.user_id}
        ...
        <div className="mb-4">
          ...
          <div className="relative">
            <select
              ...
              name="subjectId"
              className="peer block w-full cursor-pointer rounded-md border border-gray-200 py-2 pl-10 text-sm outline-2 placeholder:text-gray-500"
              defaultValue={teacherSubject.subject_id}
        ...
        <div className="mb-4">
          ...
          <div className="relative">
            <select
              ...
              name="gradeId"
              className="peer block w-full cursor-pointer rounded-md border border-gray-200 py-2 pl-10 text-sm outline-2 placeholder:text-gray-500"
              defaultValue={teacherSubject.grade_id}
        ...
        <div className="mb-4">
          ...
          <div className="relative">
            <select
              ...
              name="year"
              className="peer block w-full cursor-pointer rounded-md border border-gray-200 py-2 pl-10 text-sm outline-2 placeholder:text-gray-500"
              defaultValue={teacherSubject.year}
